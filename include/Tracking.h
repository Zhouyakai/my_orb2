...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const cv::Mat &depthmap, cv::Mat &mask, const double &timestamp, vector<std::pair<vector<double>, int>>& detect_result);
